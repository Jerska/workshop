...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { alternative_name: @actor.alternative_name, image_path: @actor.image_path, name: @actor.name, rating: @actor.rating } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { alternative_name: @actor.alternative_name, image_path: @actor.image_path, name: @actor.name, rating: @actor.rating } }
